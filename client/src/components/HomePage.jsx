...
//                         <FaBars size={24} />
//                     </button>
//                     <h1 className="text-xl font-bold mx-auto text-pink-500">V1d30F1y</h1>
...
//                 <div className="p-4 mb-4 border-t border-gray-700 flex items-center">
//                     <input
//                         type="text"
//                         value={inputMessage}
...
//                             }
//                         }}
//                         placeholder="Type your keywords for the video..."
...
//                             setInputMessage('');
//                         }}
//                         className="ml-4 p-2 bg-pink-500 text-white rounded-lg"
//                     >
//                         Send
//                     </button>
//                 </div>
